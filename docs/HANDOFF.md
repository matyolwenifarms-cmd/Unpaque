...
- 1457 unit and component tests, four passing gates (typecheck, lint, test,
  ...
  Crossref and Unpaywall are all blocked there. A run reporting 1453 passed
...
| Research | Let a stage it never mentions look like a stage that does not exist | The status panel names only what the study holds; the full list is one disclosure below it and always says how many there are |
